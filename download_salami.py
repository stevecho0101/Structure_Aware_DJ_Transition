...
# AI Usage:
# We consulted the best way to extract the songs and Claude suggested through youtube. 
...
# Merge all songs with YouTube pairings (no genre filter)
merged = meta.merge(pairings, on="salami_id", how="inner")
